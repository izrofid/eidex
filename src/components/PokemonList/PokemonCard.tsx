...
export function PokemonCard({ pokemon }: PokemonCardProps) {
  ...
  return (
    <div onClick={() => openModal(pokemon)} className="w-full cursor-pointer">
      <div className="border-b-1 flex w-full flex-col border-zinc-100/60 dark:border-neutral-500/20 bg-neutral-800 text-white transition-colors duration-200 hover:bg-neutral-700/30">
        {/* Header */}
        <div className="flex justify-between bg-neutral-200 dark:bg-neutral-800 py-2 pl-2 shadow-sm">
